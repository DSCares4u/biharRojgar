...
@section('content')
    ...
    <script>
        ...
        //                                             <p class="text-gray-500 text-sm capitalize">${data.hire.company_name}</p>
        //                                         </div>
        //                                     </div>
        //                                     <div>
        //                                         <p class="text-gray-600 text-sm "><strong class="text-red-600">Opening Date : </strong>${data.hire.date_of_start}</p>
        //                                         <p class="text-gray-600 text-sm "><strong class="text-blue-600">Website : </strong><a target="_blank" href='${data.hire.website}' class='lowercase hover:underline'>${data.hire.website}</a></p>
        //                                         <div class="mb-2">
        //                                         <h5 class="text-sm font-normal flex gap-2"><p class='font-semibold text-gray-500'>No. of Post :</p> <p class=" text-sm"> ${data.no_of_post} </p></h5>
        //                                     </div>
        //                                     </div>
        //                                 </div>
        ...
        //                                 <div class="main flex justify-start text-gray-500">
        //                                     <div class="mb-2">
        //                                         <h5 class="text-sm font-normal flex gap-2"><p class='font-semibold text-gray-500'>Experience :</p> <p class=" text-sm"> ${data.min_experience} - ${data.max_experience} Years </p></h5>
        //                                     </div>
        //                                 </div>
        //                                 <div class="main flex justify-start text-gray-500">
        //                                     <div class="mb-2">
        //                                         <h5 class="text-sm font-normal flex gap-2"><p class='font-semibold text-gray-500'>Language Required :</p> <p class=" text-sm">${data.preferred_lang}</p></h5>
        //                                     </div>
        //                                 </div>
        //                                 <div class="main flex justify-start text-gray-500">
        //                                     <div class="mb-2">
        //                                         <h5 class="text-sm font-normal flex gap-2"><p class='font-semibold text-gray-500'>Qualification :</p> <p class=" text-sm"> ${data.qualification}</p></h5>
        //                                     </div>
        //                                 </div>
        //                                 <div class="main flex justify-start text-gray-500">
        //                                     <div class="mb-2">
        //                                         <h5 class="text-sm font-normal flex gap-2"><p class='font-semibold text-gray-500'>Salary :</p>  <p><i class="fa-solid fa-indian-rupee-sign fa-xs"></i> ${data.min_salary}</p> -<p><i class="fa-solid fa-indian-rupee-sign fa-xs"></i> ${data.max_salary}</p></h5>
        //                                     </div>
        //                                 </div>
        //                                 <hr class="bg-gray-500">
        //                                  <div class="footer flex gap-6 font-medium mt-2 capitalize text-xs">
        //                                 <p class="description line-clamp-2">${data.hire.description}</p>
            ...
            let callingSarkariJobs = () => {
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        data.forEach((job) => {
                            let language = job.preferred_lang === 'english' ?
                                "English Required" : "No English Required";
                            let exp = job.min_experience <= 1 ? "Fresher Also" :
                                "Not for Freshers";
                            ...
                            $.ajax({
                                ...
                                <div class="card w-3/4 mb-4 capitalize">
                                    <div class="block max-w-full p-4 bg-white border border-purple-300 rounded-lg hover:bg-gray-100 dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700">
                                        ...
                                        <div class="main flex justify-start text-gray-500">
                                            <div class="mb-2">
                                                <h5 class="text-sm font-normal flex gap-2"><p class='font-semibold text-gray-500'>Experience: </p><p class="text-sm">${exp}</p></h5>
                                            </div>
                                        </div>
                                        <div class="main flex justify-start text-gray-500">
                                            <div class="mb-2">
                                                <h5 class="text-sm font-normal flex gap-2"><p class='font-semibold text-gray-500'>Language Required: </p><p class="text-sm">${language}</p></h5>
                                            </div>
                                        </div>
                                        <div class="main flex justify-start text-gray-500">
                                            <div class="mb-2">
