                            ...
                            <div class="border border-gray mt-2 p-4">
                                ...
                                <div class="mt-2">
                                    <div class="mb-4 items-center">
                                        ...
                                        <input type="file" id="photo" name="photo">
                                        <img id="photoPreview" src="#" alt="Photo Preview" class="hidden w-24 h-24 object-cover mt-2"/>
                                        <p id="error-photo" class="text-red-500 text-xs font-semibold error-message"></p>
                                    </div>
                                    <div class="mb-4 items-center">
                                        <label for="signature" class="block text-sm mb-3">Upload Your Signature</label>
                                        <input type="file" id="signature" name="signature">
                                        <img id="signaturePreview" src="#" alt="Signature Preview" class="hidden w-24 h-24 object-cover mt-2"/>
                                        <p id="error-signature" class="text-red-500 text-xs font-semibold error-message"></p>
                                    </div>
                                    <div class="flex gap-3">
                                        <div class="mb-4 items-center">
            ...
            if (userId) {
                $.ajax({
                    ...
                    success: function(response) {
                        if (response.data) {
                            $('#id').val(response.data.id);
                            $('#photoPreview').attr('src', response.data.photo).removeClass('hidden');
                            $('#signaturePreview').attr('src', response.data.signature).removeClass('hidden');
                            $('#id_proof_type').val(response.data.id_proof_type);
                            $('#id_proof').val(response.data.id_proof);
                            $('#quali_certificate').val(response.data.quali_certificate);
                            $('#other_certificate').val(response.data.other_certificate);
