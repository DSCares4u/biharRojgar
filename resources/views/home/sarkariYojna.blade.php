...
<hr class="bg-gray-300 h-1 rounded-xl">
    ...
    <div class="flex mb-4 w-1/2 mt-5 ml-10">
        <input type="text" id="searchName" placeholder="Search by Name or Category" class="border p-2 w-1/2 mr-2 rounded-lg">
            ...
            let callingYojna = (searchName = '') => {
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        yojnas = data.filter(yojna => {
                                let matchName = true;

                                // Check if searchNameRole matches job name or role
                                if (searchName) {
                                    matchName = yojna.ename.toLowerCase().includes(searchName);
                                }
                                return matchName;
                            });
