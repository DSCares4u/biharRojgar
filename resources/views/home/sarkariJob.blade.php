...
<div class="flex flex-col md:flex-row">
    <div class="container p-6 bg-gray-100 rounded-lg w-full md:w-3/4 mb-10">
        <div class="heading mb-6">
            <h2 class="text-2xl font-semibold">Sarkari Jobs</h2>
            <p class="text-xs text-red-500 mt-4 font-medium md:text-sm">To avoid last minute rush, you are advised to submit your
                online application much before the last date. RRBs shall not be responsible if applicants are not able to
                submit their online application including payment of fee within the last date for any reason whatsoever.</p>
        </div>
        <div class="flex flex-col md:flex-row mb-4 w-full">
            <input type="text" id="searchNameRole" placeholder="Search by Name/ Role"
                class="border p-2 w-full md:w-1/2 mr-0 md:mr-2 mb-2 md:mb-0 rounded-lg">
            <input type="text" id="searchCityState" placeholder="Search by Location"
                class="border p-2 w-full md:w-1/2 ml-0 md:ml-2 mb-2 md:mb-0 rounded-lg">
            <button id="searchButton" class="bg-blue-500 text-white p-2 rounded-lg w-full md:w-auto">Search</button>
        </div>
        <div class="card" id="callingData"></div>
    </div>
    <div class="w-full md:w-1/4 mb-10 md:mb-2">
        <div class="mt-10 w-full md:w-[80%] bg-white border p-2 rounded shadow-lg dark:bg-gray-800 dark:border-gray-700 ">
        ...
        <div class="mt-5 w-full md:w-[85%] bg-white border p-3 rounded shadow-lg dark:bg-gray-800 dark:border-gray-700 ">
            <div class="price mt-2 mb-4">
