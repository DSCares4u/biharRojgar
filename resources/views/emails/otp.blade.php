    ...
    <div style="max-width: 600px; margin: 0 auto; background: white; border-radius: 8px; overflow: hidden; box-shadow: 0 4px 6px rgba(0, 0, 0, 0.1);">
        ...
        <div style="padding: 20px;">
            ...
            <p>If you did not request this, ignore this email or contact us immediately at 
                <a href="mailto:taskinnsolution@gmail.com" style="color: #0d9488; text-decoration: none;">taskinnsolution@gmail.com</a>.
            </p>
        </div>

        <div style="text-align: center; background-color: #f4f4f9; padding: 10px 20px; font-size: 0.9em; color: #555;">
            <p>&copy; {{ date('Y') }} <strong>Taskinn Solutions</strong>. All rights reserved.</p>
        </div>
    </div>
</body>
