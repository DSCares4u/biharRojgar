...
<div class="flex-1 flex gap-3  items-center  mt-20 mb-5">
    ...
    <div class="overflow-x-auto">
        <div class="relative overflow-x-auto shadow-md sm:rounded-lg">
            <h1 class="mb-2">Hire Plan Trash</h1>
        ...
        $(document).ready(function() {
                        ...
                        data.forEach((data) => {
                            table.append(`
                                <tr class="mt-5">
                                    ...
                                    <td class="border-b border-gray-200 px-3 text-center py-2 text-sm">${data.price}</td>
            ...
            $(document).on('click', '.restore-btn', function() {
                let id = $(this).data('id');
                    $.ajax({
                    type: "PATCH",
                    url: `{{url('/api/hire-plan/restore/${id}')}}`,
                    success: function(response) {
            ...
            $(document).on('click', '.force-delete-btn', function() {
                ...
                if (confirm("Are you sure you want to Permanently delete this Data?")) {
                    $.ajax({
                        type: 'DELETE',
                        url: `{{url('/api/hire-plan/forceDelete/${id}')}}`,
                        headers: {
