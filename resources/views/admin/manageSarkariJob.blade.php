...
<div class="flex-1 flex mt-20 items-center justify-between ">
    ...
    <a href="{{url('/admin/manage/sarkari-job/insert')}}" class="bg-indigo-500 hover:bg-indigo-800 text-white px-3 py-2 rounded">
        ...
        <table class="min-w-full bg-white border border-gray-200"id="callingData">
            <thead class="bg-gray-100">
                <tr>
                    ...
                    <th class="border-b border-gray-200 px-3 py-2 text-sm">Closing Date</th>
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        data.forEach((data,index) => {
                            table.append(`
                        <tr class="mt-5 border-b border-gray-200 text-center">
                            ...
                            <td class=" px-3 text-center py-2 text-sm">${data.role}</td>
                            <td class=" px-3 flex justify-center item-center py-2 text-sm">${data.no_of_post}</td>
                            <td class=" text-sm"style="text-align:center;">${data.closing_date}</td>
                            <td class=" px-3  flex justify-center py-2 text-sm">
                                <a href="{{url('/admin/manage/sarkari-job/${data.id}')}}"
